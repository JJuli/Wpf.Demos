namespace Wpf.Common.DataGeneration {
    using System;
    ...
    public sealed class DataGenerator {
        ...
        /// <exception cref="OverflowException"> if the <see cref="StringCase"/> enumeration value is invalid.</exception>
        /// <returns>String of random lorin epsum having a length equal to or less than the max length argument along with the specified string case applied.</returns>
        public String GetString(Int32 maxLength, StringCase stringCase, Boolean removeSpaces) {
            ...
            switch (stringCase) {
                ...
                default:
                    throw new OverflowException("Programmer did not program this value.");
            }
        }
