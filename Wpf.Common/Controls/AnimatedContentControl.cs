namespace Wpf.Common.Controls {
    ...
    public class AnimatedContentControl : ContentControl {
        ...
        public static readonly DependencyProperty DurationProperty = DependencyProperty.Register("Duration", typeof(Int32), typeof(AnimatedContentControl), new PropertyMetadata(500));
        ...
        /// <summary>
        ///     Creates a brush based on the current appearance of a visual element. The brush is an ImageBrush and once created,
